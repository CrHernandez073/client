...
@Component({
  selector: 'app-config-recepcion',
  templateUrl: './config-recepcion.component.html',
  styleUrls: ['./config-recepcion.component.css']
})
export class ConfigRecepcionComponent implements OnInit {
//busqueda
resultado: any;
tipo: number=0;
  //Formularios
